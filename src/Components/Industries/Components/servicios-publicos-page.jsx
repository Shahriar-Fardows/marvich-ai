        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-8" data-aos="fade-up">
              <div>
                <h2 className="text-3xl font-bold text-[#22d3ee] mb-6">Gestión Inteligente de Infraestructura</h2>
              ...
              <div>
                <h3 className="text-2xl font-bold text-[#22d3ee] mb-4">Aplicaciones principales</h3>
  ...
  <div className="container mx-auto px-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="border border-gray-700 p-8 rounded-xl shadow-md text-white" data-aos="fade-up" data-aos-delay="0">
        ...
        <h3 className="text-xl font-bold text-[#22d3ee] mb-2">Reducción de incidentes</h3>
        <p className="text-white">Minimiza daños accidentales a infraestructura durante excavaciones.</p>
      </div>
      ...
      <div className="border border-gray-700 p-8 rounded-xl shadow-md text-white" data-aos="fade-up" data-aos-delay="100">
        ...
        <h3 className="text-xl font-bold text-[#22d3ee] mb-2">Eficiencia operativa</h3>
        <p className="text-white">Reduce tiempos de localización y reparación de infraestructura.</p>
      </div>
      ...
      <div className="border border-gray-700 p-8 rounded-xl shadow-md text-white" data-aos="fade-up" data-aos-delay="200">
        ...
        <h3 className="text-xl font-bold text-[#22d3ee] mb-2">Gestión centralizada</h3>
        <p className="text-white">Plataforma unificada para visualizar y gestionar toda la infraestructura.</p>
      </div>
      ...
      <div className="border border-gray-700 p-8 rounded-xl shadow-md text-white" data-aos="fade-up" data-aos-delay="300">
        ...
        <h3 className="text-xl font-bold text-[#22d3ee] mb-2">Mantenimiento predictivo</h3>
        <p className="text-white">Anticipa fallos y optimiza el ciclo de vida de la infraestructura.</p>
      </div>
