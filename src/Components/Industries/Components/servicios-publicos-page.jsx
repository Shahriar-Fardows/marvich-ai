...
// import imageBanner from "../assets/servicios-publicos/banner.png"
...
//             Revoluciona la gestión de tu infraestructura
//           </h2>
//           <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="100">
//             Solicita una demostración y descubre cómo nuestra tecnología puede transformar tus servicios públicos.
//           </p>
//           <button
//             onClick={goToContact}
//             className="bg-[#22d3ee] hover:bg-[#0ea5e9] text-white font-medium py-3 px-8 rounded-md transition-colors"
...
//           alt="Servicios públicos inferior"
//           className="w-full h-full object-cover"
//         />
//       </div>
