          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div className="rounded-xl overflow-hidden shadow-lg" data-aos="fade-left">
                <img src="/placeholder.svg?height=400&width=600" alt="Minería 1" className="w-full h-64 object-cover" />
              </div>

              <div className="rounded-xl overflow-hidden shadow-lg" data-aos="fade-left" data-aos-delay="100">
                <img src="/placeholder.svg?height=400&width=600" alt="Minería 2" className="w-full h-64 object-cover" />
              </div>
            </div>
          </div>
        </div>
